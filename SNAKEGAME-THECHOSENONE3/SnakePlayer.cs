...
namespace Snake
{
    ...
    class SnakePlayer
    {
        ...
        {
            Thread.Sleep(1000);         //slows down the movement by lapsing position updates by 1s at a time
        ...
        public void OnHitWall(Direction WhichWall)
        {
            ...
            MessageBox.Show("GAME OVER - YOU HIT THE WALL"); // Display game-over message
            //put sound file here
        ...
        public void OnHitSelf()
        {
            ...
            MessageBox.Show("GAME OVER - YOU HIT YOURSELF"); // Display game-over message
            GameForm.ResetGame();
        }
